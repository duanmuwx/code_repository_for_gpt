...
# ped <- readxl::read_excel('datafiles/Filter_Pedigree_Split_TC2_2023.10.28.xlsx')
# colnames(ped) <- c("ID", "DAM", "SIRE")
# idlist=ped[substr(ped$ID,1,7)=="23TC2XM",]$ID
# ped3=pedigreeTrimming(ped,idlist)
# 
...
# ped3=unique(ped3)
# openxlsx::write.xlsx(ped3,file ="datafiles/23TC2ped_2023.10.30.xlsx")
...
# ), header = T, sep = ''))
# 
# ped <- readxl::read_excel('datafiles/23TC2ped_2023.10.30.xlsx')
# colnames(ped) <- c("Name", "DAM", "SIRE")
# ped=unique(rbind(matches,ped))
# saveRDS(ped,'datafiles/23TC2ped_2023.10.31.rds')

#ped=readRDS('datafiles/23TC2ped_2023.10.31.rds')
ped <- readxl::read_excel('datafiles/23TC2ped_2023.10.30.xlsx',sheet=1)
colnames(ped) <- c("Name", "DAM", "SIRE")
ainv <- ainverse(ped)
...
#openxlsx::write.xlsx(idx, file = "Output/1118GCA_23TC2_by_Station.xlsx")

saveRDS(idx, "Output/1118GCA_23TC2_by_Station.rds")
