...
# diease.tmp <- readRDS('datafiles/23phenos_TC2_1103.rds')
...
# saveRDS(diease.tmp.o,'datafiles/23phenos_TC2_1107.rds')

diease.tmp <- readRDS('datafiles/23phenos_TC2_1118reallocated.rds')
...
saveRDS(result.all.trait, "Output/1118diease_station_by_23TC2.rds")
...
saveRDS(result.all.trait, "Output/1118diease_loc_by_23TC2.rds")




tmp.1=readRDS("Output/1118diease_station_by_23TC2.rds")
dim(tmp.1)
...
saveRDS(result, "Output/1118diease_23TC2result.rds")
...
library(reshape2)
library(dplyr)
data <- readRDS("Output/23TC2_datalist_bluelist1118.rds") 

all.blue <- data$datclean
ckblue <- readRDS("Output/23P_datalist_bluelist.rds")
ckblue<- data$datalist$datclean
...
for (i in 1:length(all_trait_name)){
  ...
  blue.value.tmp=rbind(blue.value.tmp,ck)
...
saveRDS(result.all.trait, "Output/1118datclean_station_by_23TC2.rds")
...
saveRDS(result.all.trait, "Output/1118dataclean_loc_by_23TC2.rds")

p=readRDS("Output/1118datclean_station_by_23TC2.rds")
p$Location="All"
...
saveRDS(p_yld, "Output/1118dataclean_by_23TC2result.rds")
...
saveRDS(result.all.trait, "Output/1118blue_station_by_23TC2.rds")
...
saveRDS(result.all.trait, "Output/1118blue_loc_by_23TC2.rds")




p=readRDS("Output/1118blue_station_by_23TC2.rds")
p$Location="All"
...
saveRDS(p1blue, "Output/1118blue_by_23TC2result.rds")
...
tcblue=readRDS("Output/1118blue_by_23TC2result.rds")

tcpheno=readRDS("Output/1118dataclean_by_23TC2result.rds")

diease= readRDS("Output/1118diease_23TC2result.rds")

tc.1=full_join(tcblue,tcpheno)
tc=full_join(tc.1,diease)

tc=unique(tc)
# tc.2=tc[tc$Name=="XY1219"&tc$Location=="All",]
# tc.2$Location="HLJBQ"
# 
# tc.3=tc[tc$Name=="DH605"&tc$Location=="All",]
# tc.3$Location="HNXX1"
# tc.4=tc[tc$Name=="CD99"&tc$Location=="All",]
# tc.4$Location="SCCD"
# 
# 
# tc=rbind(tc,tc.2,tc.3,tc.4)
...
pheno <- readRDS('datafiles/23phenos_TC2_1118reallocated.rds')
...
#openxlsx::write.xlsx(result,file ="Output/1107result_by_23TC2_v1.xlsx") 
saveRDS(result,"Output/1118result_by_23TC2.rds")
...
P3P4.Anova.res=readRDS("Output/1118result_by_23TC2.rds")
...
openxlsx::write.xlsx(res.all, "Output/1118result_by_23TC2-Sort.xlsx")
