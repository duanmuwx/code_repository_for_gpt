...
extracting <- function(asr, var, individual, term, gxe=FALSE) {
  ...
  return(bvalue)
    ...
    all.blue <- readRDS("Output/19-23P_BLUE1118.rds")
    ...
    for (i in 1:length(all_trait_name)){
        ...
        # blue.value$AOA[blue.value$Station == "CC"] = "MLSP"
        # blue.value$AOA[blue.value$Station == "NW"] = "MLSP"
        # blue.value$AOA[blue.value$Station == "HRB"] = "EMSP"
    ...
    #openxlsx::write.xlsx(idx, file = "Output/1118GCA_SCA_by_19_23.xlsx")

    saveRDS(idx, "Output/1118GCA_SCA_by_19_23.rds")
