...
library(dplyr)
 ...
 diease <- readRDS('datafiles/19_23_P_phenos_1118.rds')
# diease <- readRDS('datafiles/23phenos_1103.rds')
...
#openxlsx::write.xlsx(result.all.trait, file = "Output/1118diease_by_19_23.xlsx")
saveRDS(result.all.trait, "Output/1118diease_by_19_23.rds")

# openxlsx::write.xlsx(result.all.trait, file = "Output/1031diease_by_23.xlsx")
# saveRDS(result.all.trait, "Output/1031diease_by_23.rds")
